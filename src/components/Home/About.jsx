                ...
                <Row>
                    <Col md={8} className="home-about-description">
                        ...
                        <p className="home-about-body">
                            Hi, my name is <span className="yellow">Nikhil Kumar jha </span>
                            and I'm from <span className="yellow"> Kota, Rajasthan .</span>
                            <br />
                            <br />
                            Graduate From Modi Institute of Technology, Kota Rajasthan in 2023
                            <br />
                            <br />
                ...
                <Row>
                    <Col md={12} className="home-about-social">
                        ...
                        <ul className="home-about-social-links">
                            ...
                            <li className="social-icons">
                                <a href="https://www.linkedin.com/in/nikhil-jha-010564217/" target="_blank" rel="noreferrer" className="icon-colour  home-social-icons" aria-label="linkedin">
                                    <FaLinkedinIn />
                                </a>
                            </li>
                        </ul>
